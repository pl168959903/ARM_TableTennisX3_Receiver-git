 ...
 * $Revision: 4 $
 * $Date: 15/12/29 2:47p $
 * @brief    NANO103 series RTC driver header file
 *
 * @note
...
/** @addtogroup NANO103_RTC_EXPORTED_CONSTANTS RTC Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO103_RTC_EXPORTED_CONSTANTS */


/** @addtogroup NANO103_RTC_EXPORTED_STRUCTS RTC Exported Structs
  @{
*/
...
/*@}*/ /* end of group NANO103_RTC_EXPORTED_STRUCTS */
...
/**
 *  @brief    Enable access spare register
 *
 *  @param    None
 *
 *  @return   None
